...
def plot_bar_chart(bars, title, xlabel, ylabel, filename):
    x = np.arange(3)
    width = 0.2
    ...
    ax.set_xticklabels(('Recall', 'Exact Match', 'F1'))
    ax.legend()
...
def main():
    ...
    plot_bar_chart(bars, 'Evaluation Results', 'Metrics', 'Scores', 'evaluation_results.png')
